...
static constexpr int TB_TYPE_UNKNOWN = 0;
static constexpr int TB_TYPE_PRIVATE = 1;
static constexpr int TB_TYPE_GROUP = 2;
static constexpr int TB_TYPE_SUPERGROUP = 3;
static constexpr int TB_TYPE_CHANNEL = 4;

static constexpr int TB_FILE_TYPE_NONE = 0;
static constexpr int TB_FILE_TYPE_VOICE_OGG = 1;
/* ... More ar missing ... */
